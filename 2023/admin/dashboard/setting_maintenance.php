...
<head>
    ...
    <title> Settings Maintenance | Admin OPENHOUSE 2023</title>
    <!-- plugins:css -->
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <!-- contoh -->
                                    <form class="forms-sample" action="../api/update_maintenance.php" method="post">
                                        <div class="row">
                                            <div class="col-md-6 orm-group my-2">

                                                <label>Page:</label>
                                                <select class="js-example-basic-single form-control"
                                                    id="page" name="page" required>
                                                    <?php
