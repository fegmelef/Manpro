                        ...
                        <div class="col-xxl-2 stretch-card my-2">
                            <div class="card">
                                <div class="card-body row row-cols-1 d-flex justify-content-center align-items-center">
                                    ...
                                    <?php 
                                    $sql = "SELECT count(id) as total FROM `pendaftar_maba` WHERE UKM like 'basket' AND (pembayaran is NOT null or pembayaran != '')";
                                    $query = mysqli_query($conn,$sql);
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead>
                                                ...
                                                <?php
                                                    $ukm = $_SESSION["nrp"];
                                                    $query = "SELECT * FROM pendaftar_maba WHERE ukm = '$ukm' ORDER BY tanggal";
                                                    $jumlah = 0;
                                                    $result = $conn->query($query);
